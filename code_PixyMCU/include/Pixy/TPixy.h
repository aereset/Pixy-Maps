...
public:
  ...
  void pixyBlink(uint8_t r, uint8_t g, uint8_t b, uint16_t period, uint8_t iters);
  void init();
...
/**
 * @brief Parpadea el LED de la cámara Pixy
 * 
 * @tparam LinkType 
 * @param r Rojo
 * @param g Verde
 ...
 */
template <class LinkType> void TPixy<LinkType>::pixyBlink(uint8_t r, uint8_t g, uint8_t b, uint16_t period, uint8_t iters)
{
